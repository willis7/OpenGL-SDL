...
Files:      Main.cpp   (The Source File containing the most worked with code)
            ...
            3DS.h      (The header file that holds the chunk definitions and prototypes )
...
Instructions:
        After unzipping the files, be in the '3DSFileLoader' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './3DSLoader' at the command prompt.
