...
{   
    ...
    if( forward )                                          // if we are supposed to move the camera forward
    {
        // Move our camera forward by a positive SPEED
        MoveCamera(speed);
    }
    // Check if we hit the Down arrow or the 's' key
    if( backward )                                         // if we are supposed to move the camera backward
    {
        // Move our camera backward by a negative SPEED
        MoveCamera(-speed);
    }
    // Check if we hit the Left arrow or the 'a' key
    if( left )                                             // if camera has to strafe towards its left
    {
        // Strafe the camera left
        StrafeCamera(-speed);
    }
    // Check if we hit the Right arrow or the 'd' key 
    if( right )                                            // if camera has to strafe towards its right
    {
