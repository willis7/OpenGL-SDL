...
int main(void)
{
    ...
    CreateMyWindow("www.GameTutorials.com - Camera Rotation", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
...
void HandleKeyPressEvent(SDL_keysym * keysym)
{
    switch(keysym -> sym)                                  // which key have we got
    {
       ...
       case SDLK_LEFT :
            leftPressed = true;                            // make leftPressed true
            break;
...
void HandleKeyReleaseEvent(SDL_keysym * keysym)
{
    switch(keysym -> sym)                                  // which key have we got
    {
       ...
       case SDLK_RIGHT :                                   // If we release the Down arrow Key
            rightPressed = false;                          // make rightPressed false 
            break;
