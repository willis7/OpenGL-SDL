...
//      $Program:   Camera4
//                                          
//      $Description:   Rotates the canera in 3rd person mode 
//                                       
//      $Date:      11/1/01                          
//                                          
//***********************************************************************
...
Instructions:
        After unzipping the files, be in the 'CameraPart4' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './Camera4' at the command prompt.
