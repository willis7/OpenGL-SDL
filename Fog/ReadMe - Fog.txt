...
Controls:       F - This turns the fog ON and off
                + - This increases the thickness of the fog
                - - This decreases the thickness of the fog 
                Escape - Quits the application.
                F1     - Toggles between fullscreen and windowed mode


Instructions:   
        After unzipping the files, be in the 'Fog' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './Fog' at the command prompt.
