...
Files:  Main.cpp   (The Source File containing the most worked with code)
        ...
        Frustum.cpp(The Source File containing the frustum class)
        Bitmap.bmp (The bitmap will be loaded and used to texture map)

Libraries:      opengl , SDL 


Controls Used: Mouse Movement - Looks around
               C, Space Bar, Left Mouse Click - Turns Frustum Culling on and
                    off.
               +/-  Increase and decrease the amount of spheres
               ESCAPE - quits the program
               F1 - toggles fullscreen on and off
               
Instructions:   
        After unzipping the files, be in the 'FrustumCulling' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './FrustumCulling' at the command prompt.
