...
Files:  Main.cpp   (The Source File containing the most worked with code)
        ...
        Terrain.bmp (The texture map for the terrain)
        SkyBox Files (The rest of the bmps are for the skybox)


Libraries:  opengl and SDL 

Instructions:
        After unzipping the files, be in the 'HeightMap4' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './HeightMap4' at the command prompt.
            ...
            4. W,S,UP_ARROW , DOWN_ARROW move the camera forward , backward ,
               ...
               Right Mouse Button Turns detail texturing on and off
               +/- to increas/decrease height of volumetric fog
               SPACE BAR - changes the tile for the detail texture (wraps
                       around)
