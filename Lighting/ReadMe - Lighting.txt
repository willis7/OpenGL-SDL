...
Controls:       L - This turns Lighting ON and off
                + - This moves the light position in the positive y direction
                - - This moves the light position in the negative y direction 
                Escape - Quits the application.
                F1     - Toggles between fullscreen and windowed mode


Instructions:   
        After unzipping the files, be in the 'Lighting' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './Lighting' at the command prompt.
