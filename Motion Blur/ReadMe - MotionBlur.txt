...
//  $Program:   MotionBlur  
//                                          
//  $Description:   Demonstrates a fast motion blurring in OpenGL 
//                                          
//  $Date:      2/27/02                     
//                                          
//***********************************************************************
...
Controls:       '1' - This changes the texture size to 128 (LOW QUALITY)
...
Instructions:   
        After unzipping the files, be in the 'MotionBlur' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './MotionBlur' at the command prompt.
