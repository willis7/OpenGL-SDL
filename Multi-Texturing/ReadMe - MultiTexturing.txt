...
Files:      Main.cpp   (The Source File containing the most worked with code)
            ...
            4 Bitmaps  (the bitmaps that will be texture mapped)

Libraries:      opengl and SDL 

Instructions:
        After unzipping the files, be in the 'MultiTexturing' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './MultiTexturing' at the command prompt.
            2. To quit hit the ESC key     .
            3. To switch between fullscreen and windowed mode
               hit the F1 key.
...
TROUBLESHOOTING INFO:
        ...
        5.    If it doesn't go fullscreen try setting a lower desktop
            resolution.

        6.    If you still have some problems with the code
