...
Instructions:
        After unzipping the files, be in the 'Polygon Collision' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './PolygonCollision' at the command prompt.
            2. To quit hit the ESC key     .
            3. Press F1 to toggle between fullscreen and windowed mode
            4. LEFT ARROW Key  - Moves the triangle Left (-Z axis)
            5. RIGHT ARROW Key - Moves the triangle Right (+z axis)
            6. UP ARROW Key    - Moves the triangle Up (+X axis)
            7. DOWN ARROW Key  - Moves the triangle Down (-X axis)
            8. PAGE UP         - Moves the triangle UP (Y axis)
            9. PAGE DOWN       - Moves the triangle DOWN (Y axis)
