...
//      $Program:          Quadrics                                      // 
//                                                                       //
//      $Description:   Lets you Create and texture quadric shapes       //
//                                                                       //
//      $Date:          7/12/01                                          //
//                                                                       //
//***********************************************************************//
...
void CreateTexture(UINT textureArray[],char *strFileName,int textureID)
{
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, pBitmap[0]->w, pBitmap[0]->h, GL_BGR, GL_UNSIGNED_BYTE, pBitmap[0]->pixels);
...
int main(void)
{
    ...
    CreateMyWindow("www.GameTutorials.com - Quadrics", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
