...
//      $Program:   Quadrics    
//                                          
//      $Description:   Lets you create and texture Quadrice shapes
//                                          
//      $Date:      7/12/01                     
//                                          
//***********************************************************************
...
Controls:       Left Mouse Click - Turns wireframe on and off
                Escape - Quits the application.
                F1     - Toggles between fullscreen and windowed mode


Instructions:   
        After unzipping the files, be in the 'Quadrics' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './Quadrics' at the command prompt.
...
TROUBLESHOOTING INFO:
        ...
        7.  If u see a segmentation fault , Make sure that u are using a 24 bit bitmap.
            (or a bitmap that doesn't use a color palette)
