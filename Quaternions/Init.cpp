...
int main(void)
{
    ...
    CreateMyWindow("www.GameTutorials.com - Quaternions", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
...
void HandleKeyPressEvent(SDL_keysym * keysym)
{
    switch(keysym -> sym)                               // which key have we got
    {
        ...
        case SDLK_UP:                                   // Check if we hit the UP ARROW key.
            g_vPosition.y += 0.01f;                     // Increase the rotation radius
            break;

        case SDLK_DOWN:                                 // Check if we hit the DOWN ARROW key.
            g_vPosition.y -= 0.01f;                     // Decrease the rotation radius
            break;

        case SDLK_LEFT:                                 // Check if we hit the LEFT ARROW key.
            g_vPosition.x -= 0.01f;                     // Move the sphere left along the line
            break;

        case SDLK_RIGHT:                                // Check if we hit the RIGHT ARROW key.
