...
Controls:       The mouse is used to look around and the arrow keys to move
                the camera.
...
Instructions:   
        After unzipping the files, be in the 'Sky Box' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './SkyBox' at the command prompt.
