...
Files:      Main.cpp   (The Source File containing the most worked with code)
            ...
            Image.tga  (The tga image that will be texture mapped)

Libraries:      opengl and SDL 

Instructions:
        After unzipping the files, be in the 'TexturingTGA' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './TexturingTGA' at the command prompt.
