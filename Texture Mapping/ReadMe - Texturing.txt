...
Files:      Main.cpp   (The Source File containing the most worked with code)
            ...
            bitmap.bmp (The bitmap that will be texture mapped)

Libraries:      opengl and SDL 

Instructions:
        After unzipping the files, be in the 'TextureMapping' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './TextureMapping' at the command prompt.
