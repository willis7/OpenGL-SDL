...
Files:      Main.cpp   (The Source File containing the most worked with code)
            ...
            Camera.h   (The header File that holds the Camera class prototype)
...
Instructions:
        After unzipping the files, be in the 'TimeBasedMovement' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './TimeBasedMovement' at the command prompt.
