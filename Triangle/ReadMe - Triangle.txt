...
Files:          Main.cpp     (The Source File containing the code)

Libraries:      opengl and SDL 

Instructions:
        After unzipping the files, be in the 'Triangle' directory and for

        Compiling:
            1. Just type 'make' at the command prompt.
        Running:
            1. Just type './Triangle' at the command prompt.
